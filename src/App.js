...
const [newGameState, setNewGameState] = useStoredState(initialBoxContent, "newgame ");
...
function jumble() {
  let flatContent = [
    { value: "1", colour: "#b71234", spin: null },
    { value: "2", colour: "#b71234",  },
    { value: "3", colour: "#b71234" },
    { value: "4", colour: "#b71234" },
    { value: "1", colour: "#0046ad" },
  ...
  // let jumbleContent = Array(4).fill(Array(4).fill(null));
  // for (let i = 0; i < jumbleContent.length; i++) {
  //   for (let j = 0; j < jumbleContent[i].length; j++) {
  //     let randomIndex = Math.floor(Math.random() * flatContent.length);
  //     jumbleContent[i][j] = flatContent[randomIndex];
  //     flatContent = flatContent
  //       .slice(0, randomIndex)
  //       .concat(flatContent.slice(randomIndex + 1));
  //   }
  // }
    ...
    <>
      <div>
        ...
        <div className="gameContainer">
          ...
          <Game gameState={newGameState} newGame={newGame} />
